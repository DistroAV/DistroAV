...
#ifndef NDI_LIB_FOURCC_SET_PROTECTED
// Set the most significant bit of each byte to indicate that this is a protected FourCC code.
#define NDI_LIB_FOURCC_SET_PROTECTED(cc) \
	((uint32_t)(cc) | 0x80808080)
#endif

#ifndef NDI_LIB_FOURCC_IS_PROTECTED
// Check if the most significant bit of each byte is set to indicate that this is a protected FourCC code.
#define NDI_LIB_FOURCC_IS_PROTECTED(cc) \
	(((uint32_t)(cc) & 0x80808080) == 0x80808080)
#endif
...
typedef enum NDIlib_FourCC_video_type_ex_e {
	...
	// Please note that the first 4 bytes cannot be encrypted.
	NDIlib_FourCC_video_type_ex_SHQ0_highest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_SHQ0_highest_bandwidth), // SpeedHQ 4:2:0 (protected)
	NDIlib_FourCC_type_SHQ0_highest_bandwidth_protected = NDIlib_FourCC_video_type_ex_SHQ0_highest_bandwidth_protected,                              // Backwards compatibility
	...
	// Please note that the first 4 bytes cannot be encrypted.
	NDIlib_FourCC_video_type_ex_SHQ2_highest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_SHQ2_highest_bandwidth), // SpeedHQ 4:2:2 (protected)
	NDIlib_FourCC_type_SHQ2_highest_bandwidth_protected = NDIlib_FourCC_video_type_ex_SHQ2_highest_bandwidth_protected,                              // Backwards compatibility
	...
	// Please note that the first 4 bytes cannot be encrypted.
	NDIlib_FourCC_video_type_ex_SHQ7_highest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_SHQ7_highest_bandwidth), // SpeedHQ 4:2:2:4 (protected)
	NDIlib_FourCC_type_SHQ7_highest_bandwidth_protected = NDIlib_FourCC_video_type_ex_SHQ7_highest_bandwidth_protected,                              // Backwards compatibility
	...
	// Please note that the first 4 bytes cannot be encrypted.
	NDIlib_FourCC_video_type_ex_SHQ0_lowest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_SHQ0_lowest_bandwidth), // SpeedHQ 4:2:0 (protected)
	NDIlib_FourCC_type_SHQ0_lowest_bandwidth_protected = NDIlib_FourCC_video_type_ex_SHQ0_lowest_bandwidth_protected,                              // Backwards compatibility
	...
	// Please note that the first 4 bytes cannot be encrypted.
	NDIlib_FourCC_video_type_ex_SHQ2_lowest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_SHQ2_lowest_bandwidth), // SpeedHQ 4:2:2 (protected)
	NDIlib_FourCC_type_SHQ2_lowest_bandwidth_protected = NDIlib_FourCC_video_type_ex_SHQ2_lowest_bandwidth_protected,                              // Backwards compatibility
	...
	// Please note that the first 4 bytes cannot be encrypted.
	NDIlib_FourCC_video_type_ex_SHQ7_lowest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_SHQ7_lowest_bandwidth), // SpeedHQ 4:2:2:4 (protected)
	NDIlib_FourCC_type_SHQ7_lowest_bandwidth_protected = NDIlib_FourCC_video_type_ex_SHQ7_lowest_bandwidth_protected,                              // Backwards compatibility
	...
	// H.264 video (protected) at the highest bandwidth -- the data field is expected to be prefixed with the
	// NDIlib_compressed_packet_t structure. Please note that with this protected version, the
	// NDIlib_compressed_packet_t structure portion is NOT to be encrypted. Also, the fourCC member of the
	// NDIlib_compressed_packet_t structure should not be the protected version.
	NDIlib_FourCC_video_type_ex_H264_highest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_H264_highest_bandwidth),
	NDIlib_FourCC_type_H264_highest_bandwidth_protected = NDIlib_FourCC_video_type_ex_H264_highest_bandwidth_protected, // Backwards compatibility
	...
	// H.264 video (protected) at the lowest bandwidth -- the data field is expected to be prefixed with the
	// NDIlib_compressed_packet_t structure. Please note that with this protected version, the
	// NDIlib_compressed_packet_t structure portion is NOT to be encrypted. Also, the fourCC member of the
	// NDIlib_compressed_packet_t structure should not be the protected version.
	NDIlib_FourCC_video_type_ex_H264_lowest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_H264_lowest_bandwidth),
	NDIlib_FourCC_type_H264_lowest_bandwidth_protected = NDIlib_FourCC_video_type_ex_H264_lowest_bandwidth_protected, // Backwards compatibility
	...
	// H.265/HEVC video (protected) at the highest bandwidth -- the data field is expected to be prefixed with
	// the NDIlib_compressed_packet_t structure. Please note that with this protected version, the
	// NDIlib_compressed_packet_t structure portion is NOT to be encrypted. Also, the fourCC member of the
	// NDIlib_compressed_packet_t structure should not be the protected version.
	NDIlib_FourCC_video_type_ex_HEVC_highest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_HEVC_highest_bandwidth),
	NDIlib_FourCC_type_HEVC_highest_bandwidth_protected = NDIlib_FourCC_video_type_ex_HEVC_highest_bandwidth_protected, // Backwards compatibility
	...
	// H.265/HEVC video (protected) at the lowest bandwidth -- the data field is expected to be prefixed with
	// the NDIlib_compressed_packet_t structure. Please note that with this protected version, the
	// NDIlib_compressed_packet_t structure portion is NOT to be encrypted. Also, the fourCC member of the
	// NDIlib_compressed_packet_t structure should not be the protected version.
	NDIlib_FourCC_video_type_ex_HEVC_lowest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_HEVC_lowest_bandwidth),
	NDIlib_FourCC_type_HEVC_lowest_bandwidth_protected = NDIlib_FourCC_video_type_ex_HEVC_lowest_bandwidth_protected, // Backwards compatibility
	...
	// This version is basically a frame of double the height where to top part is the color and the bottom
	// half has the alpha channel (against chroma being gray).
	NDIlib_FourCC_video_type_ex_H264_alpha_highest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_H264_alpha_highest_bandwidth),
	NDIlib_FourCC_type_h264_alpha_highest_bandwidth_protected = NDIlib_FourCC_video_type_ex_H264_alpha_highest_bandwidth_protected, // Backwards compatibility
	...
	// This version is basically a frame of double the height where to top part is the color and the bottom
	// half has the alpha channel (against chroma being gray).
	NDIlib_FourCC_video_type_ex_H264_alpha_lowest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_H264_alpha_lowest_bandwidth),
	NDIlib_FourCC_type_h264_alpha_lowest_bandwidth_protected = NDIlib_FourCC_video_type_ex_H264_alpha_lowest_bandwidth_protected, // Backwards compatibility
	...
	// This version is basically a frame of double the height where to top part is the color and the bottom
	// half has the alpha channel (against chroma being gray).
	NDIlib_FourCC_video_type_ex_HEVC_alpha_highest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_HEVC_alpha_highest_bandwidth),
	NDIlib_FourCC_type_HEVC_alpha_highest_bandwidth_protected = NDIlib_FourCC_video_type_ex_HEVC_alpha_highest_bandwidth_protected, // Backwards compatibility
	...
	// This version is basically a frame of double the height where to top part is the color and the bottom
	// half has the alpha channel (against chroma being gray).
	NDIlib_FourCC_video_type_ex_HEVC_alpha_lowest_bandwidth_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_video_type_ex_HEVC_alpha_lowest_bandwidth),
	NDIlib_FourCC_type_HEVC_alpha_lowest_bandwidth_protected = NDIlib_FourCC_video_type_ex_HEVC_alpha_lowest_bandwidth_protected, // Backwards compatibility
...
typedef enum NDIlib_FourCC_audio_type_ex_e {
	...
	// AAC audio (protected) -- the data field is expected to be prefixed with the NDIlib_compressed_packet_t
	// structure. Please note that with this protected version, the NDIlib_compressed_packet_t structure
	// portion is NOT to be encrypted. Also, the fourCC member of the NDIlib_compressed_packet_t structure
	// should not be the protected version.
	NDIlib_FourCC_audio_type_ex_AAC_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_audio_type_ex_AAC),
	...
	// Multi channel Opus stream (protected) -- unlike other compressed formats, the data field is not
	// expected to be prefixed with the NDIlib_compressed_packet_t structure. Also, the fourCC member of the
	// NDIlib_compressed_packet_t structure should not be the protected version.
	NDIlib_FourCC_audio_type_ex_OPUS_protected = NDI_LIB_FOURCC_SET_PROTECTED(NDIlib_FourCC_audio_type_ex_OPUS),
...
typedef enum NDIlib_recv_color_format_ex_e {
	...
	// v6 compressed formats: -------------------------------------------------------------------------------

	// Allow SpeedHQ frames, compressed H.264 frames, HEVC frames and HEVC/H264 with alpha -- protected or not.
	NDIlib_recv_color_format_ex_compressed_v6 = 313,
	NDIlib_recv_color_format_compressed_v6 = NDIlib_recv_color_format_ex_compressed_v6,

	// This is like a combination of the NDIlib_recv_color_format_best and NDIlib_recv_color_format_compressed_v6
	// formats. Instead of delivering just UYVY or UYVA if decompressed, a 16-bit format such as P216 or PA16
	// can also be delivered.
	NDIlib_recv_color_format_ex_compressed_v6_best = 314,
	NDIlib_recv_color_format_compressed_v6_best = NDIlib_recv_color_format_ex_compressed_v6_best,

	// Allow SpeedHQ frames, compressed H.264 frames, HEVC frames and HEVC/H264 with alpha, along with
	// compressed audio frames and OPUS support -- protected or not.
	NDIlib_recv_color_format_ex_compressed_v6_with_audio = 315,
	NDIlib_recv_color_format_compressed_v6_with_audio = NDIlib_recv_color_format_ex_compressed_v6_with_audio,
...
// frame passed in is not SpeedHQ then this will return a value of -1. To maintain backwards compatibility,
// the Q value will always be below 100 and will not suggest usage of the new SpeedHQ formats.
PROCESSINGNDILIB_ADVANCED_API
...
// 
// With supports_new_format set to false, this function will behave just like NDIlib_send_get_q_factor().
// 
// With supports_new_format set to true, this will indicate that the range of the returned Q value can extend
// to be 100 or higher to indicate it's permissible to use the new SpeedHQ formats. Even with this set to
// true, if the returned Q value is below 100, then it is required to encode using the legacy format. If the
// returned Q value is 100 or higher, indicating that the new SpeedHQ formats are permissible, to obtain the
// actual Q value would be done by subtracting 100.
PROCESSINGNDILIB_ADVANCED_API
int NDIlib_send_get_q_factor_v2(
	NDIlib_send_instance_t p_instance,
	const NDIlib_video_frame_v2_t* p_video_data,
	bool supports_new_format,
	bool* p_enable_short_dc NDILIB_CPP_DEFAULT_VALUE(NULL)
);
...
PROCESSINGNDILIB_ADVANCED_API
NDIlib_recv_advertiser_instance_t NDIlib_recv_advertiser_create_ex(
	const NDIlib_recv_advertiser_create_t* p_create_settings NDILIB_CPP_DEFAULT_VALUE(NULL),
	const char* p_config_data NDILIB_CPP_DEFAULT_VALUE(NULL)
);

// Create an instance of the receiver listener. This will return NULL if it fails to create the listener.
PROCESSINGNDILIB_ADVANCED_API
NDIlib_recv_listener_instance_t NDIlib_recv_listener_create_ex(
	const NDIlib_recv_listener_create_t* p_create_settings NDILIB_CPP_DEFAULT_VALUE(NULL),
	const char* p_config_data NDILIB_CPP_DEFAULT_VALUE(NULL)
);
...
PROCESSINGNDILIB_ADVANCED_API
NDIlib_send_advertiser_instance_t NDIlib_send_advertiser_create_ex(
	const NDIlib_send_advertiser_create_t* p_create_settings NDILIB_CPP_DEFAULT_VALUE(NULL),
	const char* p_config_data NDILIB_CPP_DEFAULT_VALUE(NULL)
);

// Create an instance of the sender listener. This will return NULL if it fails to create the listener.
PROCESSINGNDILIB_ADVANCED_API
NDIlib_send_listener_instance_t NDIlib_send_listener_create_ex(
	const NDIlib_send_listener_create_t* p_create_settings NDILIB_CPP_DEFAULT_VALUE(NULL),
	const char* p_config_data NDILIB_CPP_DEFAULT_VALUE(NULL)
);
...
// Enable or disable receiving of certain streams for the given receiver. The return value will be true if a
// change in the in the enabled states actually took place. Sometimes a change can be ignored if setting the
// state of a stream attempts to override the creation parameters of the receiver. For example, if the
// receiver was created for metadata only, it would not allow enabling the audio or video streams.
PROCESSINGNDILIB_ADVANCED_API
bool NDIlib_recv_set_enabled_streams(
	NDIlib_recv_instance_t p_instance,
	bool enable_video, bool enable_audio, bool enable_metadata
);
