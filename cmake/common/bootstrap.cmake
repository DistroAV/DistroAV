...
string(JSON _minQtVersion GET ${buildspec} minQtVersion)
string(JSON _minObsVersion GET ${buildspec} minObsVersion)
string(JSON _author GET ${buildspec} author)
string(JSON _website GET ${buildspec} website)
string(JSON _email GET ${buildspec} email)
string(JSON _updateUrl GET ${buildspec} updateUrl)
string(JSON _discordUrl GET ${buildspec} discordUrl)
string(JSON _donateUrl GET ${buildspec} donateUrl)
...
set(PLUGIN_MIN_QT_VERSION ${_minQtVersion})
set(PLUGIN_MIN_OBS_VERSION ${_minObsVersion})
set(PLUGIN_AUTHOR ${_author})
set(PLUGIN_WEBSITE ${_website})
set(PLUGIN_EMAIL ${_email})
set(PLUGIN_UPDATE_URL ${_updateUrl})
set(PLUGIN_DISCORD_URL ${_discordUrl})
set(PLUGIN_DONATE_URL ${_donateUrl})
