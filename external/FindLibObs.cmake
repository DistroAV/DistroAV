...
#
# LIBOBS_FOUND LIBOBS_INCLUDE_DIRS LIBOBS_LIBRARIES
...
find_path(
  LIBOBS_INCLUDE_DIR
  NAMES obs.h
  HINTS ENV obsPath${_lib_suffix} ENV obsPath ${obsPath}
...
function(find_obs_lib base_name repo_build_path lib_name)
  ...
  if(DEFINED _build_type_base)
    ...
    set(_build_type_${repo_build_path}${_lib_suffix}
        "${_build_type_base}${_lib_suffix}/${repo_build_path}")
  endif()

  find_library(
    ${base_name_u}_LIB
    NAMES ${_${base_name_u}_LIBRARIES} ${lib_name} lib${lib_name}
    HINTS ENV obsPath${_lib_suffix} ENV obsPath ${obsPath} ${_${base_name_u}_LIBRARY_DIRS}
...
if(LIBOBS_FOUND)
  ...
  # allows external plugins to easily use/share common dependencies that are often included with
  # libobs (such as FFmpeg)
