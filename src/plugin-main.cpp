...
extern struct obs_source_preview_info create_ndi_source_preview_info();
struct obs_source_preview_info ndi_source_preview_info;
...
bool obs_module_load(void)
{
	...
	ndi_source_preview_info = create_ndi_source_preview_info();
	obs_source_preview_register_source(&ndi_source_preview_info);
